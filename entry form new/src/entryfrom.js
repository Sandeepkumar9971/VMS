        ...
        <>
            ...
            <nav class="navbar" >
                <a class="navbar-brand" href="#">
                    <img src="vrms.png" style={{ marginLeft: "20px", marginRight: "15px", width: "50px", height: "30px" }} alt=""></img>
                </a>
            </nav>
            <div className='container' style={{ padding: "20px", marginTop: "0px" }} >
                {/* /<div class="shadow-sm p-3 mb-5 bg-white rounded"> */}
                <center><h1 style={{ fontSize: "40px", color: "#e1563f", fontWeight: "500" }}>Entry Form</h1></center>
                <center><h1 style={{ fontSize: "30px", color: "#e1563f", fontWeight: "500" }}>{this.state.organisationname}</h1></center>
                                ...
                                <div className='col-md-8'>
                                    ...
                                    <div className='row'>
                                        ...
                                        <div className='submit' style={{ justifyContent: "center", display: "flex", marginTop: "20px" }}>
                                            <button onClick={(e) => this.handleModal(e)} style={{ color: 'var(--bgcolor)', flexDirection: "row", justifyContent: "right", backgroundColor: '#e1563f' }} class="btn " type="submit" >Submit</button>
                                        </div>
